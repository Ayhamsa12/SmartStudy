    ...
    public partial class DataBase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_userQuestionVotes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SavedQuestions_UserQuestions_UserQuestionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GalaxsyId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_galaxsies", x => x.GalaxsyId);
                    table.ForeignKey(
                        name: "FK_galaxsies_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryId = table.Column<int>(type: "int", nullable: false),
                    GalaxsyId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Subjects_galaxsies_GalaxsyId",
                        column: x => x.GalaxsyId,
                        principalTable: "galaxsies",
                        principalColumn: "GalaxsyId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubjectId = table.Column<int>(type: "int", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    YouTubePlaylist = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_References", x => x.ReferenceId);
                    table.ForeignKey(
                        name: "FK_References_Subjects_SubjectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_galaxsies_SubjectId",
                table: "galaxsies",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_galaxsies_UserId",
                table: "galaxsies",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_References_SubjectId",
                table: "References",
                column: "SubjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SavedQuestions_UserQuestionId",
                table: "SavedQuestions",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_galaxsies_Subjects_SubjectId",
                table: "galaxsies",
                column: "SubjectId",
                principalTable: "Subjects",
                principalColumn: "SubjectId",
